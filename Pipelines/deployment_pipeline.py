...
class PredictionServiceLoaderParams(BaseParameters):
    """Parameters for the prediction service loader."""
    pipeline_name: str
    pipeline_step_name: str
    running: bool = True

@step(enable_cache=False)
def prediction_service_loader(params: PredictionServiceLoaderParams) -> MLFlowDeploymentService:
    """Get the prediction service started by the deployment pipeline.

    Args:
        params: PredictionServiceLoaderParams object containing:
    ...
    if not existing_services:
        raise RuntimeError(
            ...
            f"pipeline for the '{"model"}' model is currently "
            f"running."
        )
